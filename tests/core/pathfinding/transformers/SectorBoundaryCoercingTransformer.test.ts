...
import { SectorBoundaryCoercingTransformer } from "../../../../src/core/pathfinding/transformers/SectorBoundaryCoercingTransformer";
import { PathFinder } from "../../../../src/core/pathfinding/types";
import { createGameMap, createIslandMap, L, W } from "../_fixtures";

describe("SectorBoundaryCoercingTransformer", () => {
  ...
  describe("determinism", () => {
    it("shore with multiple water neighbors selects consistently", () => {
      ...
      const transformer1 = new SectorBoundaryCoercingTransformer(inner1, map);
      const transformer2 = new SectorBoundaryCoercingTransformer(inner2, map);
