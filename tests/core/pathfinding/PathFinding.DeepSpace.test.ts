...
describe("PathFinding.DeepSpace", () => {
  let game: Game;
  let worldGame: Game;
  ...
  describe("findPath", () => {
    ...
    it("returns null for land tiles", () => {
      ...
      expect(map.isSector(landTile)).toBe(true);
      expect(map.isSectorEdge(landTile)).toBe(false);
      expect(map.isDeepSpace(waterTile)).toBe(true);
    ...
    it("supports multiple start tiles", () => {
      ...
      expect(map.isDeepSpace(dest)).toBe(true);
      expect(map.isDeepSpace(source1)).toBe(true);
      expect(map.isDeepSpace(source2)).toBe(true);
  ...
  describe("shore handling", () => {
    it("path from shore to shore starts and ends on shore", () => {
      ...
      expect(map.isSectorEdge(from)).toBe(true);
      expect(map.isSectorEdge(to)).toBe(true);
