          ...
          {isLoading ? (
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/10">
                ...
                <div>
                  <p className="text-white font-bold">
                    {discord?.username ?? userMe.user.email ?? "Player"}
                  </p>
              ...
              <button
                ...
                className="w-full py-3 rounded-lg bg-red-500/20 text-red-400 border border-red-500/30 hover:bg-red-500/30 transition-colors font-medium"
              >
            ...
            <div className="flex flex-col gap-6">
              ...
              {!crazyGamesSDK.isOnCrazyGames() && (
                <button
                  ...
                  className="w-full py-3 px-6 rounded-lg bg-[#5865F2] hover:bg-[#4752C4] transition-colors text-white font-bold flex items-center justify-center gap-3"
                >
                  <svg
                    className="w-5 h-5"
                    viewBox="0 0 24 24"
              ...
              {!crazyGamesSDK.isOnCrazyGames() && (
                <div className="flex flex-col gap-3">
                  <p className="text-white/50 text-sm text-center">
                    {translateText("account_modal.or_email")}
                  </p>
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-500 transition-colors text-white font-medium text-sm"
                    >
