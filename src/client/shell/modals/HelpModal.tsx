        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-6 py-3 scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent">
          ...
          <div className="flex items-center gap-3 mb-3">
            <svg
              ...
              strokeWidth="2"
            >
              <path d="M2 20 L12 0 L22 20 L2 20" />
          ...
          <section className="mb-8">
            <div className="w-full flex flex-col items-center">
              ...
              <button
                onClick={() => showPage("page-troubleshooting")}
                className="hover:bg-white/5 px-6 py-2 text-xs font-bold transition-all duration-200 rounded-lg uppercase tracking-widest bg-blue-500/20 text-blue-400 border border-blue-500/30 shadow-[0_0_15px_rgba(59,130,246,0.2)]"
              >
            ...
            <div className="pt-2 pb-4 px-4 overflow-x-auto">
              <table className="w-full text-sm border-separate border-spacing-y-1">
                ...
                <tbody className="text-white/80">
                  <HotkeyRow
                    keys={<KeyBadge code="Escape" />}
                    action={translateText("help_modal.action_esc")}
                  />
                  <HotkeyRow
                    keys={<KeyBadge code="Enter" />}
                    action={translateText("help_modal.action_enter")}
                  />
                  <HotkeyRow
                    keys={<KeyBadge code={keybinds.toggleView} />}
                    action={translateText("help_modal.action_alt_view")}
                  />
                  <HotkeyRow
                    keys={<KeyBadge code={keybinds.coordinateGrid} />}
                    action={translateText("help_modal.action_coordinate_grid")}
                  />
                  <HotkeyRow
                    keys={<KeyBadge code={keybinds.swapDirection} />}
                    action={translateText("help_modal.bomb_direction")}
                  />
                  <HotkeyRow
                    keys={
                      <div className="inline-flex items-center gap-2">
                        <KeyBadge code={keybinds.shiftKey} />
                  ...
                  <HotkeyRow
                    keys={
                      <div className="inline-flex items-center gap-2">
                        <KeyBadge code={keybinds.modifierKey} />
                        <span className="text-white/40 font-bold">+</span>
                        <MouseIcon />
                      </div>
                    }
                  ...
                  />
                  <HotkeyRow
                    keys={<KeyBadge code={keybinds.centerCamera} />}
                    action={translateText("help_modal.action_center")}
                  />
                  <HotkeyRow
                    keys={<KeyBadge code={keybinds.pauseGame} />}
                    action={translateText("help_modal.action_pause_game")}
                  />
                  <HotkeyRow
                    keys={
                      <div className="flex flex-wrap gap-2">
                        <KeyBadge code={keybinds.gameSpeedDown} />
                        <KeyBadge code={keybinds.gameSpeedUp} />
                      </div>
                    }
                    action={translateText("help_modal.action_game_speed")}
                  />
                  <HotkeyRow
                    keys={
                      <div className="flex flex-wrap gap-2">
                        <KeyBadge code={keybinds.moveUp} />
                        <KeyBadge code={keybinds.moveLeft} />
                        <KeyBadge code={keybinds.moveDown} />
                        <KeyBadge code={keybinds.moveRight} />
                      </div>
                    }
                    action={translateText("help_modal.action_wasd")}
                  />
                  <HotkeyRow
                    keys={
                      <div className="flex flex-wrap gap-2">
                        <KeyBadge code={keybinds.zoomOut} />
                        <KeyBadge code={keybinds.zoomIn} />
                      </div>
                    }
                    action={translateText("help_modal.action_zoom")}
                  />
                  <HotkeyRow
                    keys={
                      <div className="flex flex-wrap gap-2">
                        <KeyBadge code={keybinds.attackRatioDown} />
                        <KeyBadge code={keybinds.attackRatioUp} />
                      </div>
                    }
                    action={translateText("help_modal.action_attack_ratio")}
                  />
                  <HotkeyRow
                    keys={<KeyBadge code={keybinds.resetGfx} />}
