...
export function TroubleshootingModal() {
  ...
  const tips = [
    {
      title: translateText("troubleshooting.tip1_title"),
      desc: translateText("troubleshooting.tip1_desc"),
    },
    {
      title: translateText("troubleshooting.tip2_title"),
      desc: translateText("troubleshooting.tip2_desc"),
    },
    {
      title: translateText("troubleshooting.tip3_title"),
      desc: translateText("troubleshooting.tip3_desc"),
    },
    {
      title: translateText("troubleshooting.tip4_title"),
      desc: translateText("troubleshooting.tip4_desc"),
    },
    {
      title: translateText("troubleshooting.tip5_title"),
      desc: translateText("troubleshooting.tip5_desc"),
    },
  ];
