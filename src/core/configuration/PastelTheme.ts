...
export class PastelTheme implements Theme {
  ...
  private sectorEdge = colord("rgb(204,203,158)");
  ...
  private deepSpace = colord("rgb(70,132,180)");
  private sectorBoundaryDeepSpace = colord("rgb(100,143,255)");
