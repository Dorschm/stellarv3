...
import { AStarDeepSpaceBounded } from "./AStar.DeepSpaceBounded";
...
export class AStarDeepSpaceHierarchical implements PathFinder<number> {
  ...
  private localAStar: AStarDeepSpaceBounded;
  private localAStarMultiCluster: AStarDeepSpaceBounded;
  private localAStarShortPath: AStarDeepSpaceBounded;
  ...
  constructor(
    ...
    this.localAStar = new AStarDeepSpaceBounded(map, maxLocalNodes);
    ...
    this.localAStarMultiCluster = new AStarDeepSpaceBounded(
      map,
  ...
  private findNearestNode(tile: TileRef): AbstractNode | null {
    ...
    return this.tileBFS.search(
      ...
      tile,
      maxDistance,
      (t: TileRef) => this.graph.getComponentId(t) !== SECTOR_MARKER,
