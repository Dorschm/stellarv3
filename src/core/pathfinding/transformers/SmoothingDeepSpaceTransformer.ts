...
import {
  AStarDeepSpaceBounded,
  SearchBounds,
} from "../algorithms/AStar.DeepSpaceBounded";
 ...
 */
export class SmoothingDeepSpaceTransformer implements PathFinder<TileRef> {
  private readonly mapWidth: number;
  private readonly localAStar: AStarDeepSpaceBounded;
  ...
  constructor(
    ...
    private map: GameMap,
    isTraversable: (tile: TileRef) => boolean = (t) => map.isDeepSpace(t),
  ) {
    this.mapWidth = map.width();
    this.localAStar = new AStarDeepSpaceBounded(map, LOCAL_ASTAR_MAX_AREA);
